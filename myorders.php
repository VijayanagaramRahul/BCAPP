 ...
 if(isset($_SESSION['mailormno']))
{
  ...
  <a href="myorders.php" style="color:white;" >My Orders</a>
...
<div id="main">
    ...
    {
        $uno=$_POST['uno'];
        $update="UPDATE orders SET status='completed' where ran='$uno'";
...
<?php
    ...
    while($row=mysqli_fetch_array($getdata, MYSQLI_ASSOC)){
        ...
        I  Required an  ".$row['employeeloginid']."</h3>
        <h4 align='center' style='color:white;'> Date of Order : ".$row['dateandtimeoforder']."</h4>
         <h3 align='center' style='color:yellow;'>Status : ".$row['status']."</h3>
       
        <form method='POST'> 
        <input type='hidden' name='uno' value=".$row['ran']." >
        <p align='center'><input type='submit' name='completed' value='Completed' class='btn btn-success'></p>
        </form>
        </div>
        ";
