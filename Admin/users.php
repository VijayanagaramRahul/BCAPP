...
<div id="main">
    ...
    if(isset($_POST['delete']))
    {
        ...
        $del="Delete From userdetails where mailormno='$loginid'";
...
<?php
        $query="select * from userdetails  where role='customer'" ;
    ...
    while($row=mysqli_fetch_array($getdata, MYSQLI_ASSOC)){
      ...
      Name : ".$row['name']."<br> Loginid :".$row['mailormno']."</h6>
        <h4 align='center' style='color:white;'> Date of Register : ".$row['dateandtimeofregister']."</h4>
        <form method='POST'> 
        <input type='hidden' name='loginid' value=".$row['mailormno']." >
