...
<?php
        $query="select * from userdetails  where role='Admin'" ;
    ...
    while($row=mysqli_fetch_array($getdata, MYSQLI_ASSOC)){
      ...
      Name  :".$row['name']."<br> Loginid :".$row['mailormno']."</h3>
        ...
        <p align='center'><input type='submit' name='completed' value='Delete' class='btn btn-danger'></p>
        </form>
        </div>
        ";
